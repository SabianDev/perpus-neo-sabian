<?php
    ...
    function tambahPengunjung($data) {
        global $db;
        $pnj_nama = htmlspecialchars($data["pnj_nama"]);
        $pnj_kelas = htmlspecialchars($data["pnj_kelas"]);
        
    
        //query
        $query = "INSERT INTO tb_pengunjung VALUES ('','$pnj_nama','$pnj_kelas', CURDATE())";
    ...
    if ( isset($_POST["submit"]) ) {
        ...
        if( tambahPengunjung($_POST) > 0 ){
            ...
            echo "<script>
                    ...
                    document.location.href = 'pengunjung_tambah.php';
                  </script>";
        }
    }
?>
...
<head>
    ...
    <title>Kehadiran Pengunjung</title>
    ...
    <div class="container-main container-fluid">
        <div class="sidemenu">
            ...
            <div class="sidemenu-mid">
                ...
                <button type="button" class="btn btn-sidemenu btn-sidemenu-format">
                    <span class="material-symbols-outlined">
                        sync_alt
                    </span>
                    &#12644 Peminjaman
        ...
        <div class="contents">
            <div class="contents-tambah">
                <h1 class="text-title">Kehadiran Pengunjung</h1>
                <div class="container-tambah">
                    <form action="" method="post">
                        <ul>
                            <li>
                                Nama Lengkap<br>
                                <input type="text" class="input-group-text" name="pnj_nama" required>
                            </li>
                            <li>
                                Kelas (Contoh Format : SI-R41/21)<br>
                                <input type="text" class="input-group-text" name="pnj_kelas" required>
                            </li>
                            
                            <li>
                                <button type="submit" class="btn btn-dark" name="submit">Tambah Kehadiran</button>
                                <button type="button" class="btn btn-dark" onclick="window.location.href='dashboard.php'">Kembali</button>
                            </li>
                        </ul>
