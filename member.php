                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="container-editdelete">
                                            ...
                                            <a class="a-link" href="member_ubah.php?id=<?= $row["mbr_npm"]; ?>">
                                                <button type="button" class="btn btn-dark">
                                                    Ubah
                                                </button>
                                            </a>
                                            &nbsp;
                                            <a class="a-link" href="member_hapus.php?id=<?= $row["mbr_npm"]; ?>" onclick="return confirm('Apakah yakin ingin menghapus data?')">
                                                <button type="button" class="btn btn-dark">
                                                    Hapus
                                                </button>
                                            </a>
