            ...
            <div class="contents-mid" style="overflow: hidden;">
                <div class="contents-mid-upper">
                    <div class="contents-mid-upper-title">
                        <h3>Import Data List Buku (Excel)</h3>
                    </div>
                    <div class="contents-mid-upper-button">
                        ...
                        <button class="btn btn-dark" onclick="window.location.href='list_buku.php'">Kembali</button>
                    </div>
                </div>
            
                <div class="contents-mid-lower">
                    <table class="table" id="list-buku-import">
                            <thead class="thead-dark">
                                <tr>
                                    ...
                                    <th scope="col">JML_HALAMAN</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
                                $result = $db->query("SELECT * FROM tb_buku ORDER BY bk_id ASC");
                                $num = 1;
                                if($result->num_rows > 0){
                                    while($row = $result->fetch_assoc()){
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $row['bk_pengarang'] ?></td>
                                            <td><?php echo $row['bk_penerbit'] ?></td>
                                            <td><?php echo $row['bk_thnterbit'] ?></td>
                                            <td><?php echo $row['bk_kategori'] ?></td>
                                            <td><?php echo $row['bk_halaman'] ?></td>
                                        </tr><?php
                                        $num = $num+1;
                                    }
                                }
                ...
                if(isset($_POST["import"])){
			        ...
			        foreach($reader as $key => $row){
                        ...
                        //query
                        $queryImport = "INSERT INTO tb_buku VALUES ('','$impJudul','$impPengarang','$impPenerbit','$impThnterbit','$impKategori','$impHalaman','$impStatus')";
