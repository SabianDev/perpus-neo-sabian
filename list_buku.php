    ...
    <div class="container-main container-fluid">
        ...
        <div class="contents">
            <div class="contents-mid">
                <table class="table" id="list-buku">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="container-editdelete">
                                                ...
                                                <a class="a-link" href="list_buku_view.php?id=<?= $row["bk_id"]; ?>">
                                                    <button type="button" class="btn btn-dark">
                                                        View
                                                    </button>
                                                </a>
                                                &nbsp;
                                                <a class="a-link" href="list_buku_ubah.php?id=<?= $row["bk_id"]; ?>">
                                                    <button type="button" class="btn btn-dark">
                                                        Ubah
                                                    </button>
                                                </a>
                                                &nbsp;
                                                <a class="a-link" href="list_buku_hapus.php?id=<?= $row["bk_id"]; ?>" onclick="return confirm('Apakah yakin ingin menghapus data?')">
                                                    <button type="button" class="btn btn-dark">
                                                        Hapus
                                                    </button>
                                                </a>
