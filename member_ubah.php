<?php
    ...
    $member = query("SELECT * FROM tb_member WHERE mbr_npm = $id")[0];
    ...
    function ubah($data) {
        global $db;
        $mbr_npm = $data["mbr_npm"];
        $mbr_nama = htmlspecialchars($data["mbr_nama"]);
        $mbr_angkatan = htmlspecialchars($data["mbr_angkatan"]);
    
        //query
        $query = "UPDATE tb_member SET mbr_nama='$mbr_nama', mbr_angkatan='$mbr_angkatan' WHERE mbr_npm = $mbr_npm";
    ...
    if ( isset($_POST["submit"]) ) {
        ...
        if( ubah($_POST) > 0 ){
            ...
            echo "<script>
                    ...
                    document.location.href = 'member_ubah.php';
                  </script>";
        }
    }
?>
    ...
    <div class="container-main container-fluid">
        ...
        <div class="contents">
            <div class="contents-tambah">
                <h1 class="text-title">Ubah Member</h1>
                <div class="container-tambah">
                    <form action="" method="post">
                        <input type="hidden" name="mbr_npm" value="<?= $member["mbr_npm"]; ?>">
                        <ul>
                            <li>
                                NPM<br>
                                <input type="text" class="input-group-text" name="mbr_npm" required value="<?= $member["mbr_npm"];?>">
                            </li>
                            <li>
                                Nama Lengkap<br>
                                <input type="text" class="input-group-text" name="mbr_nama" required value="<?= $member["mbr_nama"];?>">
                            </li>
                            <li>
                                Angkatan (Tahun)<br>
                                <input type="text" class="input-group-text" name="mbr_angkatan" required value="<?= $member["mbr_angkatan"];?>">
                            </li>
